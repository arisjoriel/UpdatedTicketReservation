...
public class MainActivity extends ActionBarActivity {
    public final static String EXTRA_MESSAGE = "com.example.sem1.MESSAGE";
    ...
    public void reserveTickets(View view){
        ...
        EditText ticket = (EditText) findViewById(R.id.NoOfTickets);
        String message = ticket.getText().toString();
        intent2.putExtra(EXTRA_MESSAGE, message);
        startActivity(intent2);
        final EditText tickets = (EditText) findViewById(R.id.NoOfTickets);
